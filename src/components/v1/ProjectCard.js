      ...
      {githubLink && (
        <div className="w-full">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="block text-center text-sm font-medium text-pink-300 bg-gray-900 py-2 hover:bg-pink-300 hover:text-white transition rounded-b-lg"
