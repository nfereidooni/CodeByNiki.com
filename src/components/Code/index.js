...
const CODE_DATA = [
  ...
  sqimage: flamegame,
  image: flamegame2,
  desc: "An e-commerce website with functioning add to cart and checkout features, using mySQL & Express.",
  date: "2020-10-29",
  ...
  sqimage: eatdaburger,
  image: eatdaburger2,
  desc: "A burger-eating app where you can add and eat custom burgers. Built using mySQL and Express Handlebars.",
  date: "2020-10-26",
  ...
  desc: "A web application to help you schedule your workday. Built using Moment.js to display the current time and local storage.",
  date: "2020-10-15",
  ...
  desc: "A weather dashboard that uses OpenWeather API to retrieve weather data for cities and maintains a search history using local storage.",
  date: "2020-10-11",
