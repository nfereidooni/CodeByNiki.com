  ...
  return (
      <section id="about" className="py-50 flex flex-col justify-center">
        <div className="container mx-auto px-4 py-16">
          <h1 className="text-xl md:text-3xl font-bold mb-8 text-white" style={{ color: '#ffffff' }}>About Me</h1>
