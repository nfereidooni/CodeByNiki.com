      ...
      <section id="about" className="py-50 flex flex-col justify-center">
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="mt-4 text-lg">
              ...
              <p className="mb-2 text-base md:text-lg">Outside of work, I volunteer with <a className="font-bold hover:text-pink-300 focus:text-pink-300" href="http://techtankto.com" target="_blank">TechTank</a>, where I run a monthly meeting called Code Diversity. This initiative is designed as a casual coffee chat to support women and gender-diverse folks in tech, fostering connection and inclusivity. I&apos;ve contributed to the TechTank website (built with Next.js). I also built My Jane's Walk (Next.js) as a personal tool to plan weekend walks and share discoveries with friends—the Jane's Walk organization later built their own version based on it.</p>
